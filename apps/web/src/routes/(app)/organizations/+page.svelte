	...
	<div class="content-wrapper">
		<div class="main-content">
			...
			<div class="create-org-section">
				...
				>
					<svg class="create-org-icon" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h10m-6 4v10m5-15V8a1 1 0 00-1-1H9a1 1 0 00-1 1v11M7 10h4m6 8h6v-1a1 1 0 011-1h2a1 1 0 011 1v1h2" />
					</svg>
					<span class="create-org-text">Create a new organization</span>
					<p class="create-org-description">Set up a new organization to collaborate with your team</p>
				</button>
			</div>
			...
			<div class="join-org-section">
				<button 
					type="button" 
					class="join-org-card"
					onclick={() => joinOrganizationModal?.show()}
				>
					<svg class="join-org-icon" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
					</svg>
					<span class="join-org-text">Join an organization</span>
					<p class="join-org-description">Have an invitation code? Join an existing organization to start collaborating</p>
				</button>
			</div>
...
<style lang="postcss">
	...
	.organization-avatar {
		...
		height: 52px;
		border-radius: 12px;
		background: linear-gradient(135deg, var(--clr-theme-pop-element), var(--clr-theme-purp-element));
